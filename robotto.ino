...
SoftwareSerial mySerial =  SoftwareSerial(rxPin, txPin);//imposta come pin il pin assegnato alla RX e quello alla TXd
...
void setup()  {
    ...
    mySerial.begin(115200);//imposta a quale velocità ricevere e inviare i dati
    Serial.begin(9600);
    delay(1000);
    esp01cmd("AT");
    delay(1000);
